   ...
   public GridUnit[,] InitializeGrid(GridData gridData)
    {
        ...
        InitializeGridUnits(gridSize, grid);
        InitializeMovables(gridData, grid);
        InitializeExits(gridData, grid);
        
        return grid;
    }

    private void InitializeGridUnits(Vector2Int gridSize, GridUnit[,] grid)
    {
    ...
    private void InitializeExits(GridData gridData, GridUnit[,] grid)
    {
    ...
    private void InitializeMovables(GridData gridData, GridUnit[,] grid)
    {
        foreach (var movables in gridData.MovableInfo)
        {
            ...
            // for the length of the object set the grid unit type to taken and assign the grid object to the grid unit
